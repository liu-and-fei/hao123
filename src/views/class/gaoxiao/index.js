...
export default class Tuijian extends React.Component {
  ...
  componentDidMount() {
    this.getgaoxiaolist(1); //默认加载第一页数据
  ...
  callback = () => {
    ...
    // console.log(page);
    this.getgaoxiaolist(1);
    this.getgaoxiaolist(page);
  ...
  getgaoxiaolist(page){
    fetch(`/hao123_api/stream/news?params={%22page%22:%22index_cxv3%22}&newIndex=1&size=8&max_id=0&timestamp=1562212740524&page=${page}&id=114&city=%E6%B7%B1%E5%9C%B3`)
